...
1. Ensure `pyproject.toml` has the intended version (for example, `0.1.0`).
...
python -m pip install statbelt==0.1.0
...
- If PyPI publish already happened, do not overwrite files; cut a new release (for example, `0.1.1`).
